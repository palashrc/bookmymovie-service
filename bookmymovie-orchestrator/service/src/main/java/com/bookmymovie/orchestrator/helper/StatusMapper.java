...
public class StatusMapper {
    ...
    public void mapSuccessCodeMsg(BookingResponseAcknowledge bookingResponseAcknowledge) {
        bookingResponseAcknowledge.setSuccessCode(successCode);
        bookingResponseAcknowledge.setSuccessMessage(successMessage);
    }

    public void mapAckCode(BookingResponseAcknowledge bookingResponseAcknowledge) {
